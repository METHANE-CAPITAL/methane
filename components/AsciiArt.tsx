...
const METHANE_RAW = `    __  ___     __  __
   /  |/  /__  / /_/ /_  ____ _____  ___
  / /|_/ / _ \\/ __/ __ \\/ __ \`/ __ \\/ _ \\
 / /  / /  __/ /_/ / / / /_/ / / / /  __/
/_/  /_/\\___/\\__/_/ /_/\\__,_/_/ /_/\\___/`;

const FARTPERPS_RAW = `    ______           __             _          ____
...
export function MethaneAscii({ className = '', style }: { className?: string; style?: React.CSSProperties }) {
  return (
    <pre
      className={`leading-[1.15] select-none whitespace-pre overflow-x-auto ${className}`}
      style={{ fontFamily: "'JetBrains Mono', 'Cascadia Code', 'Fira Code', 'Courier New', monospace", ...style }}
    >{METHANE_RAW}</pre>
  );
}
